...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Genesis-Bot', 'Edge', '2.0.0'] : methodCodeQR ? ['Genesis-Bot', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
console.log('🍿 Luffy no tiene Sub-Bots vinculados.');
return;
}
...
console.log(chalk.bold.greenBright(`🍿 Luffy ai conectado correctamente.`))
