...
if (!text) return conn.reply(message.chat, '> ∙۬◌⃘࣭ٜ࣪࣪࣪۬፝͜🤍᪶۫۫྆•≭ *¿Que quieres buscar en tiktok?*', message, rcanal)
...
body: proto.Message.InteractiveMessage.Body.create({ text: '> ∙۬◌⃘࣭ٜ࣪࣪࣪۬፝͜🤍᪶۫۫྆•≭ *Resultado de:* ' + text }),
