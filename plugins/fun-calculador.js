const handler = async (m, { conn, command, text, usedPrefix }) => {
  if (!text) return conn.reply(m.chat, `> ∙۬◌⃘࣭ٜ࣪࣪࣪۬፝͜🍿᪶۫۫྆•≭ *Mensiona a un Usuario.*`, m, rcanal, );
...
"《 ████████████》100%"
   ...
   let { key } = await conn.sendMessage(m.chat, {text: `> ∙۬◌⃘࣭ٜ࣪࣪࣪۬፝͜🍿᪶۫۫྆•≭ *¡Calculando Porcentaje!*`, mentions: conn.parseMention(cal)}, {quoted: fkontak})
