...
await m.reply(`${who == m.sender ? `Tienes *${user.corazones} Corazones 🤍* en tu Cartera` : `> ∙۬◌⃘࣭ٜ࣪࣪࣪۬፝͜🤍᪶۫۫྆•≭ El usuario @${who.split('@')[0]} tiene *${user.corazones} Corazones 🤍* en su Cartera`}. `, null, { mentions: [who] })}
