...
let handler = async (m, { conn, text, isOwner }) => {
  ...
  await conn.sendMessage(groupMetadata, { video: { url: pp }, gifPlayback: true, caption: '> 🍿͢⃟̤᪶፝۫۫྆͜• ⃕ ¡hola soy nuevo ت︎! ↛°᳝ꯥ‧ٓ El b͟o͟t͟ estará d͟i͟s͟p͟o͟n͟i͟b͟l͟e͟ po͟r͟ el t͟i̾e̾m̾p̾o̾ acordado٭ۣ̤ۜ፝፝፝፝֟͜͡͡͡─.', mentions: [m.sender] }, { quoted: estilo })
};
handler.tags = ['grupos']
