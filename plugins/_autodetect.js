...
await this.sendMessage(m.chat, { text: ` *ミ‧₊ 𝗅⿻⌔˽̅͢.⃗ᴀᴠɪsᴏ◠ˏ❀⋆˖彡* \n\n🍿ۜ͡.𝙼̶٭ۣ̤ۜ፝፝፝፝֟͜͡͡͡ *${usuario}*\n ͜➳ᮬ〉 𝗠𝗢𝗗𝗜𝗙𝗜𝗖𝗢 𝗘𝗟 𝗡𝗢𝗠𝗕𝗥𝗘:\n\n ͜➳ᮬ〉 *${m.messageStubParameters[0]}*`, mentions: [m.sender], mentions: (await conn.groupMetadata(m.chat)).participants.map(v => v.id) }, { quoted: fkontak, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100}) 
} else if (m.messageStubType == 22) {
await this.sendMessage(m.chat, { text: ` *ミ‧₊ 𝗅⿻⌔˽̅͢.⃗ᴀᴠɪsᴏ◠ˏ❀⋆˖彡* \n\n🍿ۜ͡.𝙼̶ *${usuario}* \n ͜➳ᮬ〉 𝗠𝗢𝗗𝗜𝗙𝗜𝗖𝗢 𝗟𝗔 𝗙𝗢𝗧𝗢`, mentions: [m.sender] }, { quoted: fkontak, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100}) 
} else if (m.messageStubType == 24) {
await this.sendMessage(m.chat, { text: ` *ミ‧₊ 𝗅⿻⌔˽̅͢.⃗ᴀᴠɪsᴏ◠ˏ❀⋆˖彡* \n\n🍿ۜ͡.𝙼̶ *${usuario}*\n ͜➳ᮬ〉 𝗠𝗢𝗗𝗜𝗙𝗜𝗖𝗢 𝗟𝗔 𝗗𝗘𝗦𝗖𝗥𝗜𝗣𝗖𝗜𝗢𝗡:\n\n${m.messageStubParameters[0]}`, mentions: [m.sender] }, { quoted: fkontak, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
...
await this.sendMessage(m.chat, { text: ` *ミ‧₊ 𝗅⿻⌔˽̅͢.⃗ᴀᴠɪsᴏ◠ˏ❀⋆˖彡* \n\n ͜➳ᮬ〉 𝗘𝗟 𝗚𝗥𝗨𝗣𝗢 𝗘𝗦𝗧𝗔 ${m.messageStubParameters[0] == 'on' ? '𝗖𝗘𝗥𝗥𝗔𝗗𝗢' : '𝗔𝗕𝗜𝗘𝗥𝗧𝗢 🍿ۜ͡.𝙼̶'}\n ${m.messageStubParameters[0] == 'on' ? '𝗦𝗢𝗟𝗢 𝗔𝗗𝗠𝗜𝗡𝗦 𝗣𝗨𝗘𝗗𝗘𝗡 𝗘𝗦𝗖𝗥𝗜𝗕𝗜𝗥' : '𝗬𝗔 𝗣𝗨𝗘𝗗𝗘𝗡 𝗘𝗦𝗖𝗥𝗜𝗕𝗜𝗥 𝗧𝗢𝗗𝗢𝗦'} 𝗘𝗡 𝗘𝗦𝗧𝗘 𝗚𝗥𝗨𝗣𝗢`, mentions: [m.sender] }, { quoted: fkontak, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
} else if (m.messageStubType == 29) {
await this.sendMessage(m.chat, { text: ` *ミ‧₊ 𝗅⿻⌔˽̅͢.⃗ᴀᴠɪsᴏ◠ˏ❀⋆˖彡* \n\n🍿ۜ͡.𝙼̶ *@${m.messageStubParameters[0].split`@`[0]}*\n ͜➳ᮬ〉 𝗔𝗛𝗢𝗥𝗔 𝗘𝗦 𝗔𝗗𝗠𝗜𝗡.:\n\n ͜➳ᮬ〉 𝗗𝗘: ${groupName}\n\n» 𝗔𝗖𝗖𝗜𝗢𝗡 𝗥𝗘𝗔𝗟𝗜𝗭𝗔 𝗣𝗢𝗥:\n🍿ۜ͡.𝙼̶ *${usuario}*`, mentions: [`${m.sender}`,`${m.messageStubParameters[0]}`], mentions: (await conn.groupMetadata(m.chat)).participants.map(v => v.id) }, { quoted: fkontak, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
} else if (m.messageStubType == 30) {
await this.sendMessage(m.chat, { text: ` *ミ‧₊ 𝗅⿻⌔˽̅͢.⃗ᴀᴠɪsᴏ◠ˏ❀⋆˖彡* \n\n🍿ۜ͡.𝙼̶ *@${m.messageStubParameters[0].split`@`[0]}*\n ͜➳ᮬ〉 𝗗𝗘𝗝𝗔 𝗗𝗘 𝗦𝗘𝗥 𝗔𝗗𝗠𝗜𝗡 𝗗𝗘:\n\n▹ 𝗚𝗥𝗨𝗣𝗢: ${groupName}\n\n▹ 𝗔𝗖𝗖𝗜𝗢𝗡 𝗥𝗘𝗔𝗟𝗜𝗭𝗔 𝗣𝗢𝗥:\n🍿ۜ͡.𝙼̶ *${usuario}*`, mentions: [`${m.sender}`,`${m.messageStubParameters[0]}`], mentions: (await conn.groupMetadata(m.chat)).participants.map(v => v.id) }, { quoted: fkontak, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
