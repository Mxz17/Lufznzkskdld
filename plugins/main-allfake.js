...
//Emojis determinado de Luffy Ai 
global.emoji = '🍿'
global.emoji2 = '🍿'
global.emoji3 = '🍿'
global.emoji4 = '🍿'
...
//mensaje en espera
global.wait = '५🍿 ᰰུ︩᷒ ㅤ፝֟᷼ᴇsᴘᴇʀᴇ ᴜɴ ᴍᴏᴍᴇɴᴛᴏ 〢sᴏʏ ʟᴇɴᴛᴏ𓁢̷̸᭄᭄͟͞';
global.waitt = '५🍿 ᰰུ︩᷒ ㅤ፝֟᷼ᴇsᴘᴇʀᴇ ᴜɴ ᴍᴏᴍᴇɴᴛᴏ 〢sᴏʏ ʟᴇɴᴛᴏ𓁢̷̸᭄᭄͟͞';
global.waittt = '५🍿 ᰰུ︩᷒ ㅤ፝֟᷼ᴇsᴘᴇʀᴇ ᴜɴ ᴍᴏᴍᴇɴᴛᴏ 〢sᴏʏ ʟᴇɴᴛᴏ𓁢̷̸᭄᭄͟͞';
...
global.fake = { contextInfo: { isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363323775906071@newsletter', newsletterName: "⌜❖-⍣ ŁџՔՔყ ਜⶇ ࣶᭂ °᳝᭨᭄·̣̇͜᭺⌟.۫", serverMessageId: -1 }
}}, { quoted: m }

global.icono = [ 
'https://qu.ax/quUg.jpg',
'https://qu.ax/AeSo.jpg',
'https://qu.ax/llnB.jpg',
'https://qu.ax/aXFg.jpg',
'https://qu.ax/SpWT.jpg',
'https://qu.ax/iduB.jpg',
].getRandom()
