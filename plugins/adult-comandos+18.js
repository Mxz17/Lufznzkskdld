...
if (!db.data.chats[m.chat].modohorny && m.isGroup) return conn.reply(m.chat, '> ∙۬◌⃘࣭ٜ࣪࣪࣪۬፝͜🍿᪶۫۫྆•≭ *¡Estos comandos están desactivados!*', m,rcanal);,
conn.reply(m.chat, `> ∙۬◌⃘࣭ٜ࣪࣪࣪۬፝͜🍿᪶۫۫྆•≭ *Enviando ${command}...*`, m, {
...
conn.sendFile(m.chat, haha, 'error.jpg', `🔥ᮬ᭄ᮬ᭄ *${command}*`, m, null, rcanal);
};
