...
yaemori += `│-▒⃟ ❊ *Plataforma* : ${platform()}\n`
yaemori += `│-▒⃟ ❊ *Servidor* : ${hostname()}\n`
yaemori += `│-▒⃟ ❊ *RAM* : ${format(totalmem() - freemem())} / ${format(totalmem())}\n`
yaemori += `│-▒⃟ ❊ *FreeRAM* : ${format(freemem())}\n`
yaemori += `│-▒⃟ ❊ *Speed* : ${latensi.toFixed(4)} ms\n`
yaemori += `│-▒⃟ ❊ *Uptime* : ${uptime}\n`
yaemori += `│-▒⃟ ❊ *Modo* : ${bot.public ? 'Privado' : 'Publico'}\n`
yaemori += `│-▒⃟ ❊ *Comandos Ejecutados* : ${toNum(totalStats)} ( *${totalStats}* )\n`
...
await conn.reply(m.chat, yaemori, fkontak, { contextInfo: { mentionedJid: [owner[0][0] + '@s.whatsapp.net'], externalAdReply: { mediaUrl: false, mediaType: 1, description: false, title: '࿉᭝ ⎝ ɪɴғᴏ ↣ ፝֟֯ʙᴏᴛ ⎝ ↯˖',body: packname, previewType: 0, thumbnail: icons, sourceUrl: redes}}})
