...
let handler = async (_0x55976e, {
    ...
    try {
        ...
        if (!_0x55976e[_0x2359c0(0x1bb)]) return _0x55976e.reply('> ∙۬◌⃘࣭ٜ࣪࣪࣪۬፝͜🍿᪶۫۫྆•≭ Responde a una *Imagen.*')
        ...
        return _0x55976e.reply('> ∙۬◌⃘࣭ٜ࣪࣪࣪۬፝͜🍿᪶۫۫྆•≭ Responde a una *Imagen.*')
    }
};
handler.tags = ['owner']
...
function _0x14c2() {
    const _0x1897e4 = ['AUTO', 'user', '8CJixwu', 'getHeight', 'getBufferAsync', 'w:profile:picture', '> ∙۬◌⃘࣭ٜ࣪࣪࣪۬፝͜🍿᪶۫۫྆•≭ Foto cambiada con exito.', 'picture', 'read', '1419731ZjYevm', 'MIME_JPEG', '82272azbcaw', '350agtQLJ', '279gQMikZ', 'mimetype', '188728rlRvtO', 'msg', 'jid', 'image', '1705364hxGRFM', '14905ZvBfug', '2578255zmHnCy', 'getWidth', 'reply', '1780230pdlTpE', 'download', 'quoted', 'query', '2810ZHRQDi', 'resize', '> ∙۬◌⃘࣭ٜ࣪࣪࣪۬፝͜🤍᪶۫۫྆•≭ Responde a una *Imagen.*', 'rowner']
    _0x14c2 = function () {
        return _0x1897e4;
    };
    return _0x14c2();
