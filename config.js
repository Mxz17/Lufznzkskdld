...
global.owner = [
  ['56983298345', '𓋈◜⿻ ♩‎   ྀ𝐌𝐱̇𝐳 ᵎ･῾♱𝆬ᮬ᭄', true],
  ['59168683798', '✎﹎𝐀𝐧𝐠̇𝐞𝐥𝐢𝐭𝐨-𝐎𝐅𝐂 ፝͜🤍᭄۫۫۫۫۫۫۫۫۫۫ ͓⃕ꪶ·࣭࣪̇', true],
  ['5493585753625', 'ᰔᩚ⭒͡᭢ ˗ˏˋ𝐀𝐥𝐞-𝐫𝐦̇𝐳ˎˊ˗ 🌷🧸𐋋᭥', true],
  ['5493816457465', '◌̊ ̖́- ␦ ᵕ̈ 𝐊𝐞𝐧𝐢𝐬𝐚𝐰̇𝐚𝐃̇𝐞𝐯 ⌯.₊·۪۫°있°', true],
  [''],
  [''],
  [''],
  [''],
...
global.wm = '𝕷𝖚𝖋𝖋𝖞 𝕬𝖎 ง'̀-'́'
global.titulowm = '̤֟✯ ʟᴜғғʏ ᴀɪ ∙۬🍿۪۫◦ᮀ྆'
global.titulowm2 = '˖࣭̣᪽̇°᳝ꯥ.͜˖-⸙⸛ 🅻︎u̸f̶f̶y͟ 𝙰𝚒 ∙۬੭ٰ৴'
global.igfg = '@mxz.18l'
global.botname = '⃕᭥ꩌ゚໋🍿݉ᐧ݉ꦷ ⃕ʟᴜғғϟ ʙᴏᴛ·࣭࣪̇˖݈݇ ﭢ𝀑'
global.dev = '`⃕᭥ꩌ゚໋🍿݉ᐧ݉ꦷ ⃕ʟᴜғғϟ ʙᴏᴛ·࣭࣪̇˖݈݇ ﭢ𝀑`\nɮy ⇿Ƭเ†คரɨს๓ ｲΣձм 💥ᮬ᭄ᮬ᭄'
